...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/player2.png', 64, 64 ),
        size: {x: 32, y:60},
        offset: {x: 4, y: 2},
        flip: false,
        maxVel: {x: 250, y: 300},
    ...
    EntityBullet = ig.Entity.extend({
        size: {x: 15, y: 9},
        animSheet: new ig.AnimationSheet( 'media/bullet.png', 36, 16 ),
        maxVel: {x: 200, y: 0},
        type: ig.Entity.TYPE.NONE,
        checkAgainst: ig.Entity.TYPE.B,
        collides: ig.Entity.COLLIDES.PASSIVE,
        init: function( x, y, settings ) {
            this.parent( x + (settings.flip ? -8 : 40) , y+35, settings );
